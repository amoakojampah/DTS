  ...
  <form method="post" action="php/register_user.php">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Email</label>
              <input type="email" class="form-control" required name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
            </div>
            <div class="form-group">
              <label>Office/Department</label>
              <input type="text"  class="form-control" placeholder="office Name" required name="office">
            </div>
            <div class="form-group">
              <label>Head Of Office</label>
               <input type="text"  class="form-control" placeholder="Head" required name="office">
            </div>
             <div class="form-group">
              <label>Role</label>
