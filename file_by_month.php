...
<p>Select Month</p>        <input type="month" id="myInput" class='form-control' onchange="myFunction()" value="2019-01" placeholder="Search dispatch date  .." title="Type Here">
</div>
<br>  
      <table class='table table-responsive table-striped b-t b-b table-hover ' id='myTable'> 
        ...
        <tr>
            ...
            <th  style="width:10%">Sent Time</th>
            <th  style="width:10%">Report Time</th>
       ...
       //     die(json_encode($response));
          ...
          $get_inbox='select t.id, f.file_no, f.subject, u.user_name, f.file_type, t.type, date(t.dispatch_time) as dispatch_time, t.report_time from user u inner join transactions t on t.sender_id=u.user_id inner join files f on t.file_id=f.id ;';
