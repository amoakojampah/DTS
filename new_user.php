    ...
    <div class="navside dk" data-layout="column">
      <div class="navbar no-radius">
        ...
        <a href="admin.php" class="navbar-brand">
        	<span class="hidden-folded inline" ><br />Document Tracking<br /><center margin="center">System</center></span>        </a>
        <!-- / brand -->
      </div>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Office Head</label>
               <input type="text"  class="form-control" placeholder="Head" required name="boss">
            </div>
             <div class="form-group">
              <label>Role</label>
