   ...
   <br>
      ...
      <div class='col-md-6'>
          ...
          <tr>
            ...
            <td><?php echo $forwarded_by; ?> at <?php echo $dispatch_time; ?></td>
          </tr>
          <tr>
            <td>DGP office no.</td>
            <td><?php echo $dgp_no; ?></td>
          </tr>
        </table>
      </div>  
      ...
      <div class="row container">
        <div class="col-sm-12">
          <strong>Linked notesheets:</strong><br><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
		    <form method="post" action="php/forward_file.php">
               ...
               <div class="md-form-group float-label">
                 <input type="date" class="md-input" required name="report_time">
