    ...
    <div class="navside dk" data-layout="column">
      <div class="navbar no-radius">
        ...
        <a href="admin.php" class="navbar-brand">
        	<span class="hidden-folded inline" ><br />Document Tracking<br /><center margin="center">System</center></span>
        </a>
        <!-- / brand -->
      </div>
...
<div class="padding">
  <div class="box">
    ...
    <div class="table-responsive container" id="datatable">
      <!-- <table data-ui-jp="dataTable" data-ui-options="{
        ...
        <input type="text" id="myInput" class='form-control' onkeyup="myFunction()" placeholder="Search for subject name.." title="Type subject">
</div>
<br>  
  ...
  $user_id=$_SESSION["user_id"];
       ...
       //     die(json_encode($response));
        ...
        //select distinct f.id,f.file_no,f.file_type,f.subject,f.description,f.sender,f.letter_date,(select user_name from user u where u.user_id=f.creator_id) as created_by,f.status from files f inner join transactions t where t.file_id=f.id;
          $get_inbox=' select f.id,f.file_no,f.file_type,f.subject,f.description,f.sender,f.letter_date,u.user_name,f.status  from files f inner join user u on u.user_id=f.creator_id ';
