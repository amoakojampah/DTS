...
<br>        
        <table class='table table-responsive table-striped b-t b-b ' id='myTable'> 
  ...
  $user_id=$_SESSION["user_id"];
       ...
       //     die(json_encode($response));
          ...
          $get_inbox='select t.id, f.file_no, f.subject, u.user_name, f.file_type, t.type,  date(t.dispatch_time) as dispatch_time, t.report_time, "Pending" as "status" from user u inner join transactions t on t.sender_id=u.user_id inner join files f on t.file_id=f.id where t.receiver_id='.$user_id.' and t.forward_status=0 and t.status=1;';
  ...
  var table1 = document.getElementById('myTable');
      ...
      for(var index = 1; index < table1.rows.length; index++)
      {
          table1.rows[index].onclick = function()
          {
              ...
              window.location='file_info.php?pid=0&tid='+id;
          };
      }
