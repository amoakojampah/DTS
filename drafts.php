    ...
    <div class="table-responsive" id="datatable">
      ...
      <thead>
       ...
       //     die(json_encode($response));
          ...
          $get_inbox='select t.id, f.file_no, f.subject, u.user_name, f.file_type, t.type, date(t.dispatch_time) as dispatch_time, t.report_time, "Draft" as "status" from user u inner join transactions t on t.sender_id=u.user_id inner join files f on t.file_id=f.id where t.Sender_id='.$user_id.' and t.status=0;';
